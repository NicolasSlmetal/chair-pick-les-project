...
@Component
public class OrderReportByChairsQueryMapper implements ObjectQueryMapper<OrderReportByChairs> {
    @Override
    public QueryResult parseParameters(Map<String, String> parameters) {
        ...
        return where.end().endingOptions().groupBy("chr_name", "ord_created_date")
