...
function createCardsForOrders(columnDiv, orders) {
    for (const order of orders) {
            ...
            for (const item of order.items) {
                ...
                textColumn.classList.add("item_description");
                ...
                sellPrice.classList.add("sell_price");
                ...
                freight.classList.add("item_freight");
                ...
                subtotal.classList.add("item_subtotal");
                ...
                total.classList.add("item_total");
                ...
                status.classList.add("item_status");
