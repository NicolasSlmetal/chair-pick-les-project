...
import { putCreditCard } from "./putCreditCard.js";
...
const allInputs = [...document.querySelectorAll("form#main input"), ...document.querySelectorAll("form#main select")];
